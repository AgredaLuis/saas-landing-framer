  ...
  return (
    <header className="sticky top-0 backdrop-blur-sm z-20">
      <div className="flex justify-center items-center py-3 bg-black text-white text-sm gap-3">
        <p className="text-white/60 hidden md:block">Streamline youer workflow and boots your productivity</p>
        <div className="inline-flex gap-1 items-center">
          <p className="cursor-pointer">Get Started for Free</p>
        ...
        <div className="container">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-6 text-black/60 items-center">
              ...
              <a href="" className="cursor-pointer">Costumers</a>
              <a href="" className="cursor-pointer">Updates</a>
